...
images:
 - url: https://justaddapicnic.com/kent/outdoors/upnor_beach/upnor_2.jpg
  ...
  <div class="row">
    ...
    <div class="col-md-6">
      <div class="card" id="portrait">
        <img src="https://justaddapicnic.com/kent/outdoors/upnor_beach/upnor_1.jpg" alt="Ooohh Look a Jellyfish!" class="img-fluid">
      </div>

      <div class="card" id="landscape">
        <img src="https://justaddapicnic.com/kent/outdoors/upnor_beach/upnor_2.jpg" alt="view fo the boats anchored in the River Medway" class="img-fluid">
      </div>  
    </div>

    <div class="col-md-6">
      <div class="card" id="lanscape">
        <img src="https://justaddapicnic.com/kent/outdoors/upnor_beach/upnor_3.jpg" alt="We found a tiny Crab!" class="img-fluid">
      </div>

      <div class="card" id="portrait">
        <img src="https://justaddapicnic.com/kent/outdoors/upnor_beach/upnor_4.jpg" alt=" An old gun bunker that has slipped onto the beach" class="img-fluid">
      </div>
    </div>
